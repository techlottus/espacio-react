...
export const getExtensionRequestHttp = async () => {
  try {
    ...
    const record = recordType.find((item) => item.name === typesFormsHelpCenter.academicHelp.assignmentExtension.id)
...
export const postExtensionRequestHttp = async (data, recordId, file) => {
  try {
